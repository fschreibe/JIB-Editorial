...
% JIB Header/Footer
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\jibvolume{12} % insert volume
\jibissue{2}   % insert issue
\jibpages{258} % insert article ID
\jibyear{2015} % insert year
...
\jibauthor{Falk Schreiber\iref{1}\jibauthorfootnote{*}{To whom correspondence should be addressed. Email: \email{falk.schreiber@monash.edu}}, %ok
           Gary D. Bader\iref{2}, %ok
           Martin Golebiewski\iref{3}, %ok
           Michael Hucka\iref{4}, %ok
           Benjamin Kormeier\iref{5}, 
           ...
           Stephan Weise\iref{11} %ok
          
           
\addjibinstitution{1}{Faculty of IT, Monash University, Clayton, Australia \& Martin Luther University Halle-Wittenberg, Germany}
...
\addjibinstitution{11}{Leibniz Institute of Plant Genetics and Crop Plant Research (IPK), Gatersleben, Germany}}
\end{jibtitlepage}
